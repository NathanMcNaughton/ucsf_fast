#!/bin/bash
#SBATCH --job-name=toy_unet_test          # Job name
#SBATCH -o ./out/toy_unet_test.%j.log   # define stdout filename; %j expands to jobid; to redirect stderr elsewhere, duplicate this line with -e instead
#
...
#SBATCH -p yugroup
#SBATCH --gres=gpu:1
#SBATCH -t 16:00:00       # set maximum run time in H:M:S
